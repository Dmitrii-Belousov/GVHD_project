...
filtered_importance <- boruta_result_90$ImpHistory[, c(important_vars_90, only_tentative_90), drop = FALSE]

# Reshape the data to plot importance scores on the y-axis
boxplot(filtered_importance, 
        main = "Boruta Feature Importance (90 Days - Filtered)",
        ylab = "Importance", 
        las = 2,  
        cex.axis = 0.4, 
        col = "lightblue", 
...
# Reshape the data to plot importance scores on the y-axis
boxplot(filtered_importance, 
        main = "Boruta Feature Importance (180 Days - Filtered)",
        ylab = "Importance", 
        las = 2,
        cex.axis = 0.4,
        col = "lightblue", 
